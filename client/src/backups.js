                ...
                <tbody>
                  {this.state.record.map((item, i) => (
                    <tr key={i}>
                        ...
                        <a href="#deleteEmployeeModal" onClick={() => this.handleDelete(item._id)} class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                            <a >Edit</a>
